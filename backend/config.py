...
class Config:
    ...
    # --------------------------------------------------------------------------
    # รายการ Origins ที่อนุญาตให้ส่งคำขอมายัง Backend ได้ (รองรับทั้ง Localhost และ LAN)
    CORS_ORIGINS = [
        "http://localhost:5173",      # Vite Dev Server บนเครื่องเดียวกัน
        "http://127.0.0.1:5173",      # Loopback IP
        "http://172.20.56.147:5173",  # LAN IP สำหรับเครื่องทดสอบ 1
        "http://172.20.56.225:5173",  # LAN IP สำหรับเครื่องทดสอบ 2
        "http://192.168.1.10:5173",   # LAN IP ตามสเปก Dashboard
    ]
